...
class RecModel(nn.Module):
    def __init__(self, num_class, hidden_size):
        ...
        # model_config = BertConfig.from_pretrained(r'D:\Projects\pre_model\chinese-bert-wwm')  # uncased chinese
        model_config = BertConfig.from_pretrained(r'D:\Projects\pre_model\bert-base-uncased')  # uncased chinese
        ...
        # bi-GRU
        self.bi_gru = nn.GRU(768, hidden_size=300, num_layers=2, bidirectional=True, dropout=0.1)
